...
// CONCATENATED MODULE: ./components/list-item.js
...
function (_Component) {
  ...
  function ListItem() {
    ...
    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(ListItem).call(this));
...
function List(props) {
  return external_react_default.a.createElement("ul", {
    ...
    return external_react_default.a.createElement(list_item_ListItem, {
...
// CONCATENATED MODULE: ./components/display.js
...
function (_Component) {
  ...
  function Display() {
    ...
    return _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(Display).call(this));
  }

  _createClass(Display, [{
    key: "render",
    value: function render() {
      if (!this.props.item) return external_react_default.a.createElement("div", null);
      ...
      }, item.label)), external_react_default.a.createElement("article", {
        style: {
          padding: '1em 0'
        }
      }, item.text), external_react_default.a.createElement("div", null, "This text is from a ", external_react_default.a.createElement("a", {
        href: item.url
      }, "Wikipedia article"), " which is released under the ", external_react_default.a.createElement("a", {
...
function (_Component) {
  ...
  function Home() {
    ...
    _this = _possibleConstructorReturn(this, getPrototypeOf_getPrototypeOf(Home).call(this));

    _defineProperty(_assertThisInitialized(_this), "state", {
      item: null
    });

    _defineProperty(_assertThisInitialized(_this), "updateInfo", function (item) {
      _this.setState({
        item: item
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      }, external_react_default.a.createElement("h1", null, "Free Imperial Cities of the Holy Roman Empire"), external_react_default.a.createElement("div", {
        style: {
          marginRight: _this.state.item ? '400px' : '0'
        }
      }, external_react_default.a.createElement(List, {
        updateInfo: _this.updateInfo
      })), external_react_default.a.createElement(display_Display, {
